(() => {
  ...
  /* ---------- Scrollspy ---------- */
  const sections = ["home", "viaggi-in-evidenza", "chi-siamo", "per-chi-viaggi", "come-funziona", "destinazioni", "servizi", "diari", "blog", "recensioni", "faq", "preventivo"]
  ...
  /* ---------- Pop-up "Richiedi informazioni" ---------- */
  const quoteModal = document.getElementById("quote-modal");
  const quoteModalScrim = document.getElementById("quote-modal-scrim");
  ...
  const quoteSuccessModal = document.getElementById("quote-success-modal");

  function openQuoteModal() {
    quoteModal.classList.add("is-open");
    quoteModalScrim.classList.add("is-open");
    document.body.style.overflow = "hidden";
  }
  function closeQuoteModal() {
    quoteModal.classList.remove("is-open");
    quoteModalScrim.classList.remove("is-open");
    document.body.style.overflow = "";
  }
  ...
  /* ---------- Destinazioni: tab a scomparsa ---------- */
  const destTabs = Array.from(document.querySelectorAll(".dest-tab"));
